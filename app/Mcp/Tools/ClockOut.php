...
class ClockOut extends Tool
{
    ...
    {
        return [
            'user_id' => $schema->integer()->description('The ID of the user clocking out (required if clock_entry_id not provided)')->optional(),
            'clock_entry_id' => $schema->integer()->description('The ID of the specific clock entry to clock out (optional)')->optional(),
            'notes' => $schema->string()->description('Additional notes for the clock entry')->optional(),
        ];
    }
}
