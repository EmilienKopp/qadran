<script lang="ts">
  ...
  let classes = $derived(active
    ...
    : 'block w-full ps-3 pe-4 py-2 border-l-4 border-transparent text-start text-base font-medium  hover:bg-gray-50 hover:border-gray-300 focus:outline-hidden focus: focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out');
</script>
