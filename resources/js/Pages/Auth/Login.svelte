  ...
  <div class="w-full max-w-md mx-auto">
    ...
    <form onsubmit={(e) => { e.preventDefault(); submit(); }}>
      <div>
        ...
        />
        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Your organization's space identifier</p>
      </div>
    ...
    <p class="mt-8 text-center text-sm text-gray-600 dark:text-gray-400">
      ...
      <Link href="/welcome/register" class="font-semibold text-indigo-600 hover:text-indigo-500 dark:text-indigo-400">
        Sign up
      </Link>
    </p>
  </div>
