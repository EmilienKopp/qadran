...
* @see app/Http/Controllers/Api/ProjectController.php:34
* @route '/api/projects'
*/
...
* @see app/Http/Controllers/Api/ProjectController.php:46
* @route '/api/projects/{id}'
*/
...
* @see app/Http/Controllers/Api/ProjectController.php:61
* @route '/api/projects/{id}'
*/
